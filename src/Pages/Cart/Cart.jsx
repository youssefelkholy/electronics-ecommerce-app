...
import { handleAlert, removeItemFromCart } from '../../redux/apiCalls/cartApiCall';
        ...
        <section className="cart">
            ...
            <div className="cart-items">
                ...
                <div key={item.id} className="cart-item">
                    ...
                    <BsTrashFill onClick={()=> dispatch(removeItemFromCart(item.id),handleAlert("error","تم حذف المنتج من القائمة"))} className="cart-item-delete-icon" />
                    </div>
                </div>
                ))}
            </div>
